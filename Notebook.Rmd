...
kuang.mtx <- as.matrix(kuang_t)
row.names(kuang.mtx) <- NULL
transpose.kuang.mtx <- t(kuang.mtx)
heatmap.2(transpose.kuang.mtx,
          Rowv = cluster1.tree.final,  # use the dendrogram previously calculated
          ...
          xlab = "Perturbations",
          main = "Cluster 1 over all Perturbations")
```
