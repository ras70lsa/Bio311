...
```{r}
rnaseq <- read.csv("../../kuang-2014-rnaseq-expression.csv") #local needs to be changed
rnatime <- read.csv("../../kuang-2014-rnaseq-expression-timepts.csv")
```
...
colnames(rnaseq_t) <- nrna

#dim(rnaseq_t)
#dim(rnatime)
#tail(rnaseq_t[0:5])
rnaseq_t.time <- cbind(rnaseq_t, time = rnatime$hour)
#head(rnaseq_t.time[6241:6242])
```
...
ggplot(rnaseq_t.time, aes(x = time, y = YAL001C, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL001C")

ggplot(rnaseq_t.time, aes(x = time, y = YAL002W, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL002W")

ggplot(rnaseq_t.time, aes(x = time, y = YAL003W, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL003W")

ggplot(rnaseq_t.time, aes(x = time, y = YAL004W, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL004W")

ggplot(rnaseq_t.time, aes(x = time, y = YAL005C, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL005C")

ggplot(rnaseq_t.time, aes(x = time, y = YAL007C, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL007C")

ggplot(rnaseq_t.time, aes(x = time, y = YAL008W, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL008W")

ggplot(rnaseq_t.time, aes(x = time, y = YAL009W, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL009W")

ggplot(rnaseq_t.time, aes(x = time, y = YAL010C, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL010C")

ggplot(rnaseq_t.time, aes(x = time, y = YAL011W, group = 1)) + geom_line() + labs(x = "Time (minutes)", y = "Expression of Gene", title = "YAL011W")
```

```{r}
rnaseq.cor <- cor(rnaseq_t, use = "pairwise.complete.obs") #warning that standard deviation is zero
