...
length(cut1.cut2.genes1)
length(cut1.cut2.genes2)
kuang_t.cor2 <- kuang_t.cor[cluster2.genes,cluster2.genes]
...
Our final hierarchical clusters, based on the work shown above (hierarchical and correlation distributions), are given below.
...
Given our final clusters we generated some heatmaps to show the correlation between genes within clusters. In most cases, the number of genes in a given cluster was too large to create one heatmap. Thus, often we were forced to create heatmaps with certain subsets of clusters. 
