...
Next, we wanted to explore how different clusters were expressed over time with relation to one another. First, we chose the three subclusters that were created from the original first cluster. 
...
The above figure is the result of plotting the expression of the three subclusters of the original cluster over time. 
