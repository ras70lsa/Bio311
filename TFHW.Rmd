...
#sort, close, but not working on last two
Gcn.sorted <- Gcn.new[match(Gcn.new, kuangtf.new)]
#Esa.sorted <- Esa.new[match(Esa.new, kuangtf.new)]
#Set.sorted <- Set.new[match(Set.new, kuangtf.new)]
```
