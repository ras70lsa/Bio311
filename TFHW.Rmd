...
We do not know if any of the target genes are themselves also TFs. Additional data and analysis would be needed to determine this. TODO??
...
kcluster1.genes[match(Gcn.genes.above.plot, kcluster1.genes)]
kcluster2.genes[match(Gcn.genes.above.plot, kcluster2.genes)]
kcluster3.genes[match(Gcn.genes.above.plot, kcluster3.genes)]
```
