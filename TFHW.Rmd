...
Next in the pipeline we had to chose a filtering threshold. We chose a correlation value of 0.75 to distinguish which TFs regulated which genes. At first the chosing of this correlation value was quite arbitrary. In a sense we were "inventing the wheel" for this type of analysis and thus had no point of reference for a good starting point. 
...
Based on the result of the code below the following is clear: 
...
length(test[match(Gcn.genes.above.plot, test)])
