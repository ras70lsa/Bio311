...
Another biological process term that came up in the GO analysis was **oxidation-reduction process**. It would be interesting to explore if the reduction of oxididation also produced oscillatory effects on the metabolic cycle. 

TODO: isn't oxidation-reduction an actual process? not necessarily the "reduction" of oxidation. don't think the analsis above makes sense. 
...
- Some GO terms also dealth with the effect of resource-deprivation on the metabolic cycle (oxidation-reduction process). TODO don't think this makes sense
