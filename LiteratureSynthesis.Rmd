...
```
With a miniscule p-value of 6.76e-72, the first gene ontology term of note out of cluster 2 is **structural constituent of ribosome**.  The paper by Kuang et al., that is the basis for our project, deals with changes in chromatin status across robust metabolic cycles.  It is possibe that the structural consituent of ribosome plays a large role in these chromatic state changes.
