...
The next term of note that appeared in this cluster is **oxidation-reduction process**.  Contrary to what one may infer from the name, oxidation-reduction is a chemical reaction that involves a transfer of electrons between two species.
...
head(gcn.go[,columns.of.interest.tf]) ##make more readable
...
head(esa.go[,columns.of.interest.tf]) ##make more readable
...
head(set.go[,columns.of.interest.tf]) ##make more readable
