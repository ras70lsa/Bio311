...
head(gcn.go[,columns.of.interest]) ##make more readable
...
head(esa.go[,columns.of.interest]) ##make more readable
...
head(set.go[,columns.of.interest]) ##make more readable
