...
cluster1.profile.sorted[,columns.of.interest] ##make more readable
```
...
Note: in the GO analysis section, we provided detailed analysis on each paper that we cited. This section provides a summary of our results.
